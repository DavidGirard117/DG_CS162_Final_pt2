...
<div class="w3-bar w3-white w3-large">
  ...
  <a href="#room" class="w3-bar-item w3-button w3-mobile">Room</a>
  <a href="#employee" class="w3-bar-item w3-button w3-mobile">Employee</a>
  <a href="#Customer" class="w3-bar-item w3-button w3-mobile">Customer</a>
...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  ...
  <div class="w3-display-left w3-padding w3-col l6 m8">
    <div class="w3-container w3-red">
      <h2><i class="fa fa-bed w3-margin-right"></i>Ceil</h2>
    </div>
